...
to setup
  ...
  [
    set color 19
    set size .5
    set chromosome n-values 1024 [random-action]
...
true
0
Polygon -955883 true false 75 120 150 270 225 120
Polygon -14835848 true false 75 120 60 90 90 105 105 60 120 90 150 60 165 90 180 60 195 90 210 75 210 90 240 90 225 120 225 120 225 120
